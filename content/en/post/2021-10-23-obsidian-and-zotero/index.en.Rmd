...
- I have exported my full Zotero library as a `Library.bib` file, which is stored at the top level of my vault^[This is the folder in your computer where your Vault lives. In my case it is also in my synchronized OneDrive for back-up.]. If you make changes to your library, you have to export it again, but then Obsidian automatically refreshes.
